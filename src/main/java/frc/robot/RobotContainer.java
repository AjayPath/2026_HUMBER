...
public class RobotContainer {
  ...
  public Command getLeftSideAuto() {
    ...
    new SequentialCommandGroup(
          ...
          new ParallelDeadlineGroup(
            new DriveToPoint(m_robotDrive, 4.2, -3.5, 270, 0.25, 5),
            new RunIntake(s_intakeSubsystem, s_pivotSubsystem, 80, 119)
          ),
          ...
          new ShootSequence(s_shooterSubsystem, s_feederSubsystem, s_floorSubsystem, m_robotDrive, s_intakeSubsystem, s_pivotSubsystem).withTimeout(2.35), // 2.75
  ...
  public Command getRightSideAuto() {
    return 
    new SequentialCommandGroup(
      new SetPivotPosition(s_pivotSubsystem, 75),
